...
import com.ntsocial.meshlink.core.resources.alert_bell_buzzer
import com.ntsocial.meshlink.core.resources.alert_bell_led
import com.ntsocial.meshlink.core.resources.alert_bell_vibra
import com.ntsocial.meshlink.core.resources.alert_message_buzzer
import com.ntsocial.meshlink.core.resources.alert_message_led
import com.ntsocial.meshlink.core.resources.alert_message_vibra
import com.ntsocial.meshlink.core.resources.external_notification
import com.ntsocial.meshlink.core.resources.external_notification_config
import com.ntsocial.meshlink.core.resources.external_notification_enabled
import com.ntsocial.meshlink.core.resources.nag_timeout_seconds
import com.ntsocial.meshlink.core.resources.notifications_on_alert_bell_receipt
import com.ntsocial.meshlink.core.resources.notifications_on_message_receipt
import com.ntsocial.meshlink.core.resources.output_buzzer_gpio
import com.ntsocial.meshlink.core.resources.output_duration_milliseconds
import com.ntsocial.meshlink.core.resources.output_led_active_high
import com.ntsocial.meshlink.core.resources.output_led_gpio
import com.ntsocial.meshlink.core.resources.output_vibra_gpio
import com.ntsocial.meshlink.core.resources.ringtone
import com.ntsocial.meshlink.core.resources.use_i2s_as_buzzer
import com.ntsocial.meshlink.core.resources.use_pwm_buzzer
    ...
    RadioConfigScreenList(
        ...
        item {
            TitledCard(title = stringResource(Res.string.advanced)) {
                val gpio = remember { com.ntsocial.meshlink.feature.settings.util.gpioPins }
                DropDownPreference(
