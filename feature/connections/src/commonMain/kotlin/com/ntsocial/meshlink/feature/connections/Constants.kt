 ...
 * [com.ntsocial.meshlink.feature.connections.model.DeviceListEntry]'s `fullAddress`. Persisted by
 * `radioInterfaceService` so the UI layer can distinguish "user explicitly disconnected" from "first launch".
 */
