...
import com.ntsocial.meshlink.core.resources.details
...
import com.ntsocial.meshlink.feature.node.component.CompassSheetContent
import com.ntsocial.meshlink.feature.node.component.FirmwareReleaseSheetContent
...
private fun NodeDetailOverlays(
    ...
    val requestLocationPermission =
        com.ntsocial.meshlink.core.ui.util.rememberRequestLocationPermission(
            onGranted = { node?.let { onRequestPosition(it) } },
            onDenied = {},
        )
    val openLocationSettings = com.ntsocial.meshlink.core.ui.util.rememberOpenLocationSettings()
