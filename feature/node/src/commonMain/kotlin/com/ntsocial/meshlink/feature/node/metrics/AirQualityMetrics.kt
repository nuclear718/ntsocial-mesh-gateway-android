...
/** Selectable chart metric enum for air quality data series. Internal so [getValue] can be unit-tested. */
...
private fun AirQualityChart(
    ...
    MetricChartScaffold(
        ...
        legendData = LEGEND_DATA.filter { legendData -> activeMetrics.any { it.labelRes == legendData.nameRes } },
        modifier = modifier,
