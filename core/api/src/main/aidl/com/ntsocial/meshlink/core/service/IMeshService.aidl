...
Once you have bound to the service you should register your broadcast receivers per https://developer.android.com/guide/components/broadcasts#context-registered-receivers
    ...
    // com.ntsocial.meshlink.x broadcast intents, where x is:
    ...
    // (i.e. com.ntsocial.meshlink.RECEIVED.TEXT_MESSAGE_APP) else the numeric portnum will be included as a base 10 integer (com.ntsocial.meshlink.RECEIVED.4403 etc...)
