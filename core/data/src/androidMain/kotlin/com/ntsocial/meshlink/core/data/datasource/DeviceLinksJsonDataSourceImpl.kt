...
class DeviceLinksJsonDataSourceImpl(private val application: Application) : DeviceLinksJsonDataSource {
    ...
    @OptIn(ExperimentalSerializationApi::class)
    override fun loadDeviceLinksFromJsonAsset(): NetworkDeviceLinksResponse =
        application.assets.open("device_links.json").use { inputStream ->
            json.decodeFromStream<NetworkDeviceLinksResponse>(inputStream)
        }
}
