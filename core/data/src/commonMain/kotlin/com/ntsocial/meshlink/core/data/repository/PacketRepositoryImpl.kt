...
import com.ntsocial.meshlink.core.repository.PacketRepository as SharedPacketRepository
...
class PacketRepositoryImpl(private val dbManager: DatabaseProvider, private val dispatchers: CoroutineDispatchers) :
    ...
    private fun com.ntsocial.meshlink.core.database.dao.PacketDao.getAllWaypointsFlow(): Flow<List<RoomPacket>> =
