...
import com.ntsocial.meshlink.core.repository.ServiceBroadcasts as SharedServiceBroadcasts
...
class ServiceBroadcasts(private val context: Context, private val serviceRepository: ServiceRepository) :
    ...
    private fun Node.toLegacy(): NodeInfo = NodeInfo(
        num = num,
        user =
        com.ntsocial.meshlink.core.model.MeshUser(
            id = user.id,
        ...
        position =
        com.ntsocial.meshlink.core.model
            .Position(
                latitude = latitude,
                longitude = longitude,
        ...
        lastHeard = lastHeard,
        deviceMetrics =
        com.ntsocial.meshlink.core.model.DeviceMetrics(
        ...
        channel = channel,
        environmentMetrics =
        com.ntsocial.meshlink.core.model.EnvironmentMetrics.fromTelemetryProto(environmentMetrics, 0),
        hopsAway = hopsAway,
    ...
    /**
     * See com.ntsocial.meshlink broadcast intents.
     *
