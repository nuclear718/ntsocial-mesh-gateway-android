...
import com.ntsocial.meshlink.core.ui.theme.HyperlinkBlue
...
/**
 * A [Text] component that highlights occurrences of [query] within [text]. Each matching token in the query is
 * highlighted independently and case-insensitively.
 */
@Composable
fun HighlightedText(
    text: String,
...
private fun buildHighlightedString(
    ...
    var cursor = 0
    for (range in mergeRanges(matchRanges.sortedBy { it.first })) {
