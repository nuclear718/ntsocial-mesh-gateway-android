...
// NTsocial Gateway visual identity.
// Primary: Indigo #4F46E5, Secondary: Emerald #10B981, Tertiary: Amber #F59E0B.
...
val onSecondaryLight = Color(0xFF111827)
...
val onTertiaryLight = Color(0xFF111827)
val tertiaryContainerLight = Color(0xFFFFEDD5)
val onTertiaryContainerLight = Color(0xFF7C2D12)
val errorLight = Color(0xFFEF4444)
val onErrorLight = Color(0xFFF9FAFB)
...
val secondaryDark = Color(0xFF10B981)
...
val onTertiaryDark = Color(0xFF111827)
val tertiaryContainerDark = Color(0xFF92400E)
val onTertiaryContainerDark = Color(0xFFFFF7ED)
val errorDark = Color(0xFFDC2626)
val onErrorDark = Color(0xFFF9FAFB)
...
val onSurfaceVariantDark = Color(0xFFE5E7EB)
...
val surfaceContainerLowestDark = Color(0xFF030712)
val surfaceContainerLowDark = Color(0xFF111827)
val surfaceContainerDark = Color(0xFF1F2937)
