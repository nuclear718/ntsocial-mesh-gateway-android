    ...
    private fun makePosition(numIn: Int) = FromRadio(
        ...
        MeshPacket(
            ...
            Data(
                ...
                payload =
                ProtoPosition(
                    latitude_i = com.ntsocial.meshlink.core.model.Position.degI(32.776665),
                    longitude_i = com.ntsocial.meshlink.core.model.Position.degI(-96.796989),
                    altitude = 150,
    ...
    private fun sendConfigResponse(configId: Int) {
        ...
        fun makeNodeInfo(numIn: Int, lat: Double, lon: Double) = FromRadio(
            ...
            NodeInfo(
                ...
                position =
                ProtoPosition(
                    latitude_i = com.ntsocial.meshlink.core.model.Position.degI(lat),
                    longitude_i = com.ntsocial.meshlink.core.model.Position.degI(lon),
                    altitude = 35,
                    time = nowSeconds.toInt(),
