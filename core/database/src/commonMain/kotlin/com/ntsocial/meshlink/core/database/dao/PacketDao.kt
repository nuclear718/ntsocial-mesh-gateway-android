...
interface PacketDao {
    ...
    /**
     * Populates [Packet.messageText] for historical text packets that predate the FTS5 schema. The text is decoded in
     * Kotlin from each packet's [DataPacket.text] payload.
     */
    @Transaction
