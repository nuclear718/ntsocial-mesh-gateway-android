...
/** Pins a secondary graph to one immutable BLE and database identity. */
internal class IosFixedEndpointRadioPrefs(private val profile: RadioEndpointProfile) : RadioPrefs {
...
internal class IosFixedEndpointMeshPrefs(profile: RadioEndpointProfile, private val delegate: MeshPrefs) : MeshPrefs {
