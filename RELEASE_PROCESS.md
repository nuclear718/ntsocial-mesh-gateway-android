...
Flatpak packaging is maintained externally at [vidplace7/com.ntsocial.meshlink.desktop](https://github.com/vidplace7/com.ntsocial.meshlink.desktop). It builds `:desktop:packageUberJarForCurrentOS` (not the native distribution pipeline) and includes its own AppStream metainfo, `.desktop` entry, and JBR bundling.
