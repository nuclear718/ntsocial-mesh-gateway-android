 ...
 */
package com.ntsocial.meshlink.app.map.node
...
import com.ntsocial.meshlink.app.map.addCopyright
import com.ntsocial.meshlink.app.map.addPolyline
import com.ntsocial.meshlink.app.map.addPositionMarkers
import com.ntsocial.meshlink.app.map.addScaleBarOverlay
import com.ntsocial.meshlink.app.map.model.CustomTileSource
import com.ntsocial.meshlink.app.map.rememberMapViewWithLifecycle
 ...
 *
 * Applies the
 * [lastHeardTrackFilter][com.ntsocial.meshlink.feature.map.BaseMapViewModel.MapFilterState.lastHeardTrackFilter] from
 * [MapViewModel] to filter positions by time, matching the behavior of the Google Maps implementation. Includes a
 * minimal [MapControlsOverlay][com.ntsocial.meshlink.feature.map.component.MapControlsOverlay] with a track time filter
 * slider so users can adjust the time range directly from the map.
 *
 * Supports optional synchronized selection via [selectedPositionTime] and [onPositionSelected].
 *
 * Unlike the main [com.ntsocial.meshlink.app.map.MapView], this composable does **not** include node clusters,
 * waypoints, or location tracking. It is designed to be embedded inside the position-log adaptive layout.
 */
@Composable
fun NodeTrackOsmMap(
