...
internal data class RadioEndpointScopeContext(
...
/** Makes endpoint Koin scopes discoverable by Android Compose without exposing them to shared hosts. */
@Single
class RadioEndpointScopeRegistry {
