...
import com.ntsocial.meshlink.app.map.GoogleMapMode
import com.ntsocial.meshlink.app.map.MapView
 ...
 * [com.ntsocial.meshlink.core.model.Node] via [NodeMapViewModel] and delegates to [MapView] in
 * [GoogleMapMode.NodeTrack] mode, which provides the full shared map infrastructure (location tracking, tile providers,
 * controls overlay with track filter).
 *
